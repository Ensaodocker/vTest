...
#docker_file for Debien_test
cmd2= "docker build -t debien_test ./Docker_file/Debien_Test "
subprocess.run(cmd2 ,shell=True) 
print("#"*77)

#docker_file for Debien
cmd2= "docker build -t debien ./Docker_file/Debien "
subprocess.run(cmd2 ,shell=True) 
print("#"*77)
...
cmd1= "docker build -t iphping ./Docker_file/ipspoofing "
subprocess.run(cmd1 ,shell=True)
print("#"*77)
...
cmd1= "docker pull sauravbrahma/metasploit_image:latest "
subprocess.run(cmd1 ,shell=True)
print("#"*77)
...
#docker_file for SessionHijacking
cmd1= "docker pull tleemcjr/metasploitable2 "
subprocess.run(cmd1 ,shell=True)
print("#"*77)
